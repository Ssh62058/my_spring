...
<a class="dropdown-item" href="${contextPath}/shop/list?c=204&l=2">맥스파이시 상하이버거</a>
    ...
    <li class="nav-link dropdown">
        ...
        <ul class="dropdown-menu">
<li>
<a class="dropdown-item" href="${contextPath}/shop/list?c=301&l=2">치킨치즈머핀</a>
</li>
<li>
<a class="dropdown-item" href="${contextPath}/shop/list?c=302&l=2">에그머핀</a>
</li>
<li>
<a class="dropdown-item" href="${contextPath}/shop/list?c=303&l=2">베이컨에그맥머핀</a>
</li>
<li>
<a class="dropdown-item" href="${contextPath}/shop/list?c=304&l=2">베이크에그맥그리들</a>
</li>
        </ul>
    </li>
    <li class="nav-link dropdown">
...
<a class="dropdown-item" href="${contextPath}/shop/list?c=504&l=2">아이스 카페라떼</a>
    ...
    <li class="nav-link dropdown">
        ...
        <ul class="dropdown-menu">
<li>
<a class="dropdown-item" href="${contextPath}/shop/list?c=601&l=2">불고기버거</a>
</li>
<li>
<a class="dropdown-item" href="${contextPath}/shop/list?c=602&l=2">치즈버거</a>
</li>
